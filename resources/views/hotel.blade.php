...
<body>
    ...
    <section class="about-bannner" style="background-image: url({{ $url }})">
        <div class="banner-content">
            <h1>{{ (isset($banner))?$banner->main_title:'Hotel' }}</h1>
            <ul>
                <li><a href="index.html">Home</a> <i class="fa-solid fa-arrow-right-long"></i> </li>
                <li>{{ (isset($banner))?$banner->main_title:'Hotel' }}</li>
            </ul>
        </div>
    </section>
    <!-- banner section end -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="hotel-content">
                                    <div class="hotel-content-top">
                                        <h4>
                                            <a href="{{ url('/hotel/'.$list->url) }}">{{ $list->hotel_title }}</a>
                                        </h4>
                                        ...
                                        <ul class="hotel-faclities">
                                            @if($list->highlights != '')
                                            @php 
                                            $frontmodel = new App\Models\Front_model;
                                            $highlights = $frontmodel->get_highlights($list->highlights);
                                            @endphp
                                            @foreach($highlights as $li)
                                            <li>
                                                <img src="{{ url('public/frontassets/images/'.$li->image) }}" alt="icon">
                                                {{ $li->name }}
                                            </li>
                                            @endforeach
                                            @endif
                                            <?php /* <li>
                                                <img src="{{ url('public/frontassets/images/icon-Framegas.svg') }}" alt="icon">
                                                Heater
                                            </li>
                                            <li>
                                                <img src="{{ url('public/frontassets/images/icon-Framelock.svg') }}" alt="icon">
                                                Saving Safe
                                            </li>
                                            <li>
                                                <img src="{{ url('public/frontassets/images/Framewififree-04.svg') }}" alt="icon">
                                                Free Wifi
                                            </li>
                                            <li>
                                                <img src="{{ url('public/frontassets/images/Framephone-05.svg') }}" alt="icon">
                                                Phone
                                            </li> */ ?>
                                        </ul>
                                    </div>
                                    <div class="hotel-content-bottom">
                                        <div class="room-type">
                                            @if($list->other_features != '')
                                            @foreach(json_decode($list->other_features) as $val)
                                                <h5>{{ $val }}</h5>
                                            @endforeach
                                            @endif
                                            <!-- <h5>Semi Double</h5>
                                            <p>1 king bed</p> -->
                                            @if($list->other_text1 != '' && $list->other_text2 != '')
                                            <div class="hotel-deals">
                                                <span>
                                                    <strong>{{ $list->other_text1 }}</strong>
                                                    <br>
                                                    {{ $list->other_text2 }}
                                                </span>
                                            </div>
                                        ...
                                        <div class="book-price">
                                            <div class="price-area">
                                                <p>
                                                    {{ $list->night }} Night, {{ $list->max_people }} Adults
                                                </p>
                                                <span>
                                                    {{ $list->sp }}
                                                    <del>{{ $list->mrp }}</del>
                                            ...
                                            <a href="javascript:void(0)" onclick="send_enquiry('',{{ $list->h_id }})" class="hotel-btn comman-btn-hover"> Check Availability <i
                            ...
                            <div class="col-md-8">
                                <div class="hotel-content">
                                    <div class="hotel-content-top">
                                        <h4>
                                            <a href="#">Twilight Serenity Manor</a>
                                        </h4>
                                        <div class="hotel-location">
                                            <ul>
                                                <li> <i class="fa-solid fa-location-dot"></i> </li>
                                                <li>#SCF 11, 1st floor, Sarojini colony, Phase 1,Opp.Head office,Near
                                                    BusStand, Yamunanagar 6F Gopala Tower Rajendra PlaceNew Delhi India
                                                    - 110008</li>
                                            </ul>
                                        </div>
                                        <ul class="hotel-faclities">
                                            <li>
                                                <img src="{{ url('public/frontassets/images/icon-Framefahin.svg') }}" alt="icon">
                                                TV
                                            </li>
                                            <li>
                                                <img src="{{ url('public/frontassets/images/icon-Framegas.svg') }}" alt="icon">
                                    ...
                                    <div class="hotel-content-bottom">
                                        ...
                                        <div class="book-price">
                                            ...
                                            <a href="#" class="hotel-btn comman-btn-hover"> Check Availability <i
                                                    class="fa-solid fa-arrow-right"></i> </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="hotel-content">
                                    <div class="hotel-content-top">
                                        <h4>
                                            <a href="#">Tranquil Twilight Lodge</a>
                                        </h4>
                                        <div class="hotel-location">
                                            <ul>
                                                <li> <i class="fa-solid fa-location-dot"></i> </li>
                            ...
                            <div class="col-md-8">
                                <div class="hotel-content">
                                    <div class="hotel-content-top">
                                        <h4>
                                            <a href="#">Harmony Haven Hideaway</a>
                                        </h4>
                                        <div class="hotel-location">
                                            <ul>
                                                <li> <i class="fa-solid fa-location-dot"></i> </li>
