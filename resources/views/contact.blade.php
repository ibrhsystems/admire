...
<body>
      ...
      <div class="row">
          ...
          <ul class="contact-info-box">
            <li>
              ...
              <p>
                ...
                <br>
                <a href="javascript:void(0)">{{ $settings->address2 }}</a>
              </p>
            </li>
          </ul>
        </div>
        <div class="col-md-7">
          <div class="form-box">
            ...
            <form action="{{ url('/home/save_contact_us') }}" method="post" enctype="multipart/form-data" autocomplete="off" id="contact_us_form">
              @csrf
              <div class="row">
                <div class="col-md-12">
                  <div class="input-box">
                ...
                <div class="col-md-12">
                  <div class="input-box">
                    ...
                    <textarea rows="4" class="form-control" placeholder="What’s on your mind" name="message"
                      id="message">
                    </textarea>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="submit-button-box">
                    <button type="button" id="contact-submit-btn">Submit Now </button>
                  </div>
                </div>
              </div>
            </form>
  ...
  <script>
    $('#contact-submit-btn').click(function(){
      $("#contact_us_form").find("span").html('');
