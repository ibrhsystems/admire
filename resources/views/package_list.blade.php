...
<body>
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                               ...
                               <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropend dropdown"><a class="dropdown-item dropdown-toggle" href="international-tour.html">international tour</a>
                                      <ul class="dropdown-menu dropdown-submenu">
    ...
    <!-- Domestic tour banner section start -->
    @php
    ...
    <section class="about-bannner" style="background-image: url({{ $url }})">
        <div class="banner-content">
            <h1>{{ (isset($page_title))?$page_title:'Thrilling Tour Plans' }}</h1>
            <ul>
                <li><a href="{{ url('/') }}">Home</a> <i class="fa-solid fa-arrow-right-long"></i> </li>
                <li>{{ (isset($page_title))?$page_title:'Thrilling Tour Plans' }}</li>
            </ul>
        </div>
     </section>
    <!--Domestic tour banner section end -->
        ...
        <div class="container">
            <div class="row gy-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="{{ url($list->url) }}">
                            <img src="{{ url(IMAGE_PATH.$list->tour_image) }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>{{ $list->tour_title }}</h4>
                            <ul>
                                <li> <i class="fa-regular fa-calendar-days"></i> {{ $list->day }} Days / {{ $list->night }} Night </li>
                            </ul>
                            <div class="tour-bottom-content">
                                <div class="tour-price">
                                    ...
                                    <p class="tour-price-content">
                                        {{ $list->sp }}
                                        <del>{{ $list->mrp }}</del>
                                    </p>
                                    <span>TAXES INCL/PERS</span>
                                </div>
                                <a href="javascript:void(0)" class="comman-btn-hover" onclick="send_enquiry({{ $list->p_id }})">Book A Trip <i class="fa-solid fa-plane"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php /*<div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="#">
                            <img src="{{ url('public/frontassets/images/Tour-Package-12-650x450.webp') }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>Embracing City Lights, Landm, And Iconic Culture.</h4>
                            <ul>
                                <li> <i class="fa-regular fa-calendar-days"></i> 4 Days / 5 Night </li>
                            </ul>
                            <div class="tour-bottom-content">
                                <div class="tour-price">
                                    <Span class="title">
                                    ...
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#enquiry-form" class="comman-btn-hover">Book A Trip <i class="fa-solid fa-plane"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="#">
                            <img src="{{ url('public/frontassets/images/Tour-Package-05-650x450.webp') }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>Immersive Cultural Expirees, Local Cuisine.</h4>
                            <ul>
                                <li> <i class="fa-regular fa-calendar-days"></i> 4 Days / 5 Night </li>
                            </ul>
                            <div class="tour-bottom-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="#">
                            <img src="{{ url('public/frontassets/images/Tour-Package-06-650x450.webp') }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>Exploring Ancient Ruins, Histor Landmarks, And Cultural.</h4>
                            <ul>
                                <li> <i class="fa-regular fa-calendar-days"></i> 4 Days / 5 Night </li>
                            </ul>
                            <div class="tour-bottom-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="#">
                            <img src="{{ url('public/frontassets/images/Tour-Package-07-650x450.webp') }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>Adventure Art, Architecture, And Mediterranean.</h4>
                            <ul>
                                <li> <i class="fa-regular fa-calendar-days"></i> 4 Days / 5 Night </li>
                            </ul>
                            <div class="tour-bottom-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="#">
                            <img src="{{ url('public/frontassets/images/Tour-Package-09-650x450.webp') }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>A Journey Of Tour Beauty And Inspiration.</h4>
                            <ul>
                                <li> <i class="fa-regular fa-calendar-days"></i> 4 Days / 5 Night </li>
                            </ul>
                            <div class="tour-bottom-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="#">
                            <img src="{{ url('public/frontassets/images/Tour-Package.webp') }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>A Journey Of Tour Beauty And Inspiration.</h4>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tour-box package-box">
                        <a href="#">
                            <img src="{{ url('public/frontassets/images/Tour-Package-11-650x450.webp') }}" alt="tour">
                        </a>
                        <div class="tour-plans-content package-content">
                            <h4>Embark Tranquility, Adventure, And Spiritual.</h4>
                            <ul>
                                <li> <i class="fa-regular fa-calendar-days"></i> 4 Days / 5 Night </li>
                            </ul>
                            <div class="tour-bottom-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="company-info">
                            ...
                            <div class="num-deatail">
                               ...
                               <address>#SCF 11, 1st floor, Sarojini colony, Phase 1,Opp.Head office,Near BusStand, Yamunanagar 6F Gopala Tower Rajendra PlaceNew Delhi India - 110008</address>
                        </div> 
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="input-box">
                              ...
                              <input type="tel" class="form-control"  id="emailID" name="emailID"   placeholder=" Phone number"/>
                             </div>
                          </div>
                          <div class="col-md-6">
                            <div class="input-box">
                          ...
                          <div class="col-md-12">
                            <div class="input-box">
                              ...
                              <textarea rows="4" class="form-control" name="message"  id="message" placeholder="whats on your mind"></textarea>
                            </div>
                          </div>
