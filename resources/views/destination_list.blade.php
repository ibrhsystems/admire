...
<head>
    ...
    <title>International Tour</title>
    ...
    <section class="destination-box">
        <div class="container">
            <div class="row">
                ...
                @php $countPackage = $frontmodel->get_count_package_by_location($list->id); @endphp
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="{{ url($list->url) }}" class="">
                            <div class="slider-box image-hover">
                                <img src="{{ url(IMAGE_PATH.$list->image) }}" alt="destination">
                                <span class="tour-btn">{{ $countPackage }} tour</span>
                ...
                @endforeach
                @endif
                <?php /* <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="#">
                            <div class="slider-box image-hover">
                                <img src="{{ url('public/frontassets/images/Destination-04.webp') }}" alt="destination">
                                <span class="tour-btn">2 tour</span>
                                <div class="slider-content">
                                    <p>travel to</p>
                                    <h4>japan</h4>
                                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="#" class="">
                            <div class="slider-box image-hover">
                                <img src="{{ url('public/frontassets/images/Destination-05.webp') }}" alt="destination">
                                <span class="tour-btn">1 tour</span>
                                <div class="slider-content">
                                    <p>travel to</p>
                                    <h4>india</h4>
                                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="#">
                            <div class="slider-box image-hover">
                                <img src="{{ url('public/frontassets/images/Destination-06.webp') }}" alt="destination">
                                <span class="tour-btn">1 tour</span>
                                <div class="slider-content">
                                    <p>travel to</p>
                                    <h4>brazil</h4>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="#" class="">
                            <div class="slider-box image-hover">
                                <img src="{{ url('public/frontassets/images/Destination-08.webp') }}" alt="destination">
                                <span class="tour-btn">1 tour</span>
                                <div class="slider-content">
                                    <p>travel to</p>
                                    <h4>australia</h4>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="#">
                            <div class="slider-box image-hover">
                                <img src="{{ url('public/frontassets/images/Destination-09.webp') }}" alt="destination">
                                <span class="tour-btn">0 tour</span>
                                <div class="slider-content">
                                    <p>travel to</p>
                                    <h4>spain</h4>
                                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="#">
                            <div class="slider-box image-hover">
                                <img src="{{ url('public/frontassets/images/Tour-Package-09-650x450.webp') }}" alt="destination">
                                <span class="tour-btn">1 tour</span>
                                <div class="slider-content">
                                    <p>travel to</p>
                                    <h4>Italy</h4>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="destination-box-2">
                        <a href="#" class="">
                            <div class="slider-box image-hover">
                                <img src="{{ url('public/frontassets/images/Destination-07.webp') }}" alt="destination">
                                <span class="tour-btn">4 tour</span>
                                <div class="slider-content">
                                    <p>travel to</p>
                                    <h4>Indonesia</h4>
                                </div>
