...
<body>
    ...
    <section class="about-bannner" style="background-image: url({{ $url }})">
        <div class="banner-content">
            <h1>{{ ucwords($hotel->hotel_title) }}</h1>
            <ul>
                <li><a href="{{ url('/') }}">Home</a> <i class="fa-solid fa-arrow-right-long"></i> </li>
                <li>{{ ucwords($hotel->hotel_title) }}</li>
            </ul>
        </div>
    </section>
    <!-- banner section end -->
            ...
            <div class="row g-3">
                <div class="col-lg-6">
                    <div class="hotel-box overlay-box">
                        <a data-fancybox="gallery" href="{{ url(IMAGE_PATH.$hotel->image) }}">
                            <img src="{{ url(IMAGE_PATH.$hotel->image) }}" alt="image">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="details-box overlay-box">
                                <a data-fancybox="gallery" href="{{ url(IMAGE_PATH.$hotel->image2) }}">
                                    <img src="{{ url(IMAGE_PATH.$hotel->image2) }}" alt="image">
                                    <div class="overlay"><i class="fa-solid fa-plus"></i></div>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="details-box overlay-box">
                                <a data-fancybox="gallery" href="{{ url(IMAGE_PATH.$hotel->image3) }}">
                                    <img src="{{ url(IMAGE_PATH.$hotel->image3) }}" alt="image">
                                    <div class="overlay"><i class="fa-solid fa-plus"></i></div>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="details-box overlay-box">
                                <a data-fancybox="gallery" href="{{ url(IMAGE_PATH.$hotel->image4) }}">
                                    <img src="{{ url(IMAGE_PATH.$hotel->image4) }}" alt="">
                                    <div class="overlay"><i class="fa-solid fa-plus"></i></div>
                                </a>
                        ...
                        <div class="col-md-6">
                            <div class="details-box overlay-box">
                                ...
                                <a data-fancybox="gallery" href="{{ url(IMAGE_PATH.$hotel->image5) }}">
                                    <img src="{{ url(IMAGE_PATH.$hotel->image5) }}" alt="">
                                    <div class="overlay"><i class="fa-solid fa-plus"></i></div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="details-content">
                        ...
                        <div class="deatails-area">
                            <h6>
                                ...
                                <span>{{ explode('/', $hotel->price_text)[0] }}</span>
                                /
                                <strong>{{ explode('/', $hotel->price_text)[1] }}</strong>
                                @endif
                            </h6>
                        </div>
                        ...
                        <p>{!! $hotel->children !!}</p>
                        <h4>Highlights</h4>
                        @php $frontmodel = new App\Models\Front_model; @endphp
                        <ul class="room-features">
                        
                            @if($hotel->highlights != '')
                            @php
                            $highlights = $frontmodel->get_highlights($hotel->highlights);
                            @endphp
                            @if(sizeof($highlights))
                            ...
                            <li>
                                <img src="{{ url('public/frontassets/images/Frameac.svg') }}" alt="icon">
                                Air Condition
                            </li>
                            <li>
                        ...
                        <ul class="extra-service">
                            @if($hotel->facilities != '')
                            @php
                            $facilities = $frontmodel->get_facilities($hotel->facilities);
                            @endphp
                            @if(sizeof($facilities))
                            @foreach($facilities as $li)
                            <li>
