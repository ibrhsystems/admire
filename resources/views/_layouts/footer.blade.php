    ...
    @php 
        ...
        $settings = $commonmodel->get_setting();
    @endphp
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-logo-section">
                            <div class="footer-logo">
                                <a href="{{ url('/') }}"><img src="{{ url('public/frontassets/images/admire-logo (1).png') }}" alt="admire-logo"></a>
                            </div>
                            <h4>Want to Take Tour Packages?</h4>
                            <a href="#" class="book-button">Book A Tour</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="menu-title">
                            ...
                            <div class="menu-links">
                                <ul>
                                    ...
                                    <li><a href="{{ url('/package-list') }}">Tour Package</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="company-info">
                            ...
                            <div class="num-deatail">
                               ...
                               <address>{{ $settings->address }}, {{ $settings->address2 }}</address>
                        </div> 
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-here">
                            ...
                            <div class="footer-icons">
                                <ul>
                                    <li><a href="javascript:void(0)"><img src="{{ url('public/frontassets/images/visa-logo.svg') }}" alt="image"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{ url('public/frontassets/images/stripe-logo.svg') }}" alt="image"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{ url('public/frontassets/images/paypal-logo.svg') }}" alt="image"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{ url('public/frontassets/images/woo-logo.svg') }}" alt="image"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{ url('public/frontassets/images/skrill-logo.svg') }}" alt="image"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="footer-bottom-icons">
                            <div class="social-icon">
                                <a href="{{ $settings->facebook_link }}"> <i class="fa-brands fa-facebook-f"></i> </a>
                                <a href="{{ $settings->twitter_link }}"> <i class="fa-brands fa-twitter"></i> </a>
                                <a href="{{ $settings->linkedin_link }}"> <i class="fa-brands fa-linkedin"></i> </a>
                                <a href="{{ $settings->instagram_link }}"> <i class="fa-brands fa-instagram"></i> </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="copyright">
                            <p>©Copyright {{ date('Y') }} | Admire Tourism </p>
                        </div>
                    </div>
                    <div class="col-lg-4">
