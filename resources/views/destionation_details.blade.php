...
<body>
    ...
    <section class="brazil-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="brazil-heading">
                        <h2>{{ ucwords($solo->title) }}</h2>
                        <!-- <p>Egypt has one of the longest histories of any country, tracing its heritage along the Nile
                            Delta back to the 6th–4th millennia BCE. Considered a cradle of civilisation, Ancient Egypt
                            saw some of the earliest developments of writing, agriculture, urbanisation, organised
                            religion and central government.[15] Egypt’s long and rich cultural heritage is an integral
                            part of its national identity, which reflects its unique transcontinental location being
                            simultaneously Mediterranean, Middle Eastern and North African.[16] Egypt was an early and
                            important centre of Christianity, but was largely Islamised in the seventh century. Modern
                            Egypt dates back to 1922, when it gained independence from the British Empire as a monarchy.
                            Following the 1952 revolution, Egypt declared itself a republic, and in 1958 it merged with
                            Syria to form the United Arab Republic, which dissolved in 1961.
                        </p> -->
                        {!! $solo->description !!}
                    </div>
                    <div class="row g-2">
                        @if($solo->image != '')
                        <div class="col-lg-4">
                            <div class="brazil-box image-hover">
                                <img src="{{ url(IMAGE_PATH.$solo->image) }}" alt="image">
                            </div>
                        </div>
                        @endif
                        @if($solo->image2 != '')
                        <div class="col-lg-4">
                            <div class="brazil-box image-hover">
                                <img src="{{ url(IMAGE_PATH.$solo->image2) }}" alt="image">
                            </div>
                        </div>
                        @endif
                        @if($solo->image3 != '')
                        <div class="col-lg-4">
                            <div class="brazil-box image-hover">
                                <img src="{{ url(IMAGE_PATH.$solo->image3) }}" alt="image">
                            </div>
                        </div>
                        @endif
                        @if($solo->image4 != '')
                        <div class="col-lg-4">
                            <div class="brazil-box image-hover">
                                <img src="{{ url(IMAGE_PATH.$solo->image4) }}" alt="image">
                            </div>
                        </div>
                        @endif
                        @if($solo->image5 != '')
                        <div class="col-lg-4">
                            <div class="brazil-box image-hover">
                                <img src="{{ url(IMAGE_PATH.$solo->image5) }}" alt="image">
                            </div>
                        </div>
                        @endif
                        @if($solo->image6 != '')
                        <div class="col-lg-4">
                            <div class="brazil-box image-hover">
                                <img src="{{ url(IMAGE_PATH.$solo->image6) }}" alt="image">
                            </div>
                        </div>
                        @endif
                    </div>
                    <div class="brazil-heading">
                        <h2>{{ ucwords($solo->title2) }}</h2>
                        <!-- <p>Egypt has one of the longest histories of any country, tracing its heritage along the Nile
                            Delta back to the 6th–4th millennia BCE. Considered a cradle of civilisation, Ancient Egypt
                            saw some of the earliest developments of writing, agriculture, urbanisation, organised
                            religion and central government.[15] Egypt’s long and rich cultural heritage is an integral
                            part of its national</p> -->
                        {!! $solo->description2 !!}
                    </div>
                    <!-- <ul class="list">
                    ...
                    <div class="slider-clip">
                        <div class="slider-image owl-carousel owl-theme">
                            <div class="item">
                                <div class="tour-box package-box destination-card">
                                    <a href="#" class="image-hover">
                                        <img src="{{ url('public/frontassets/images/Tour-Package.webp') }}" alt="tour">
                                    </a>
                                    <div class="tour-plans-content package-content slider-bootom">
                                        <h4>Discover Serenity, Exploration, and Enlightenment.</h4>
                                        <div class="tour-bottom-content">
                                            ...
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#enquiry-form"
                                                class="comman-btn-hover">Book A Trip <i class="fa-solid fa-plane"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tour-box package-box destination-card">
                                    ...
                                    <div class="tour-plans-content package-content slider-bootom">
                                        ...
                                        <div class="tour-bottom-content">
                                            ...
                                            <a href="#" class="comman-btn-hover" data-bs-toggle="modal"
                                                data-bs-target="#enquiry-form">Book A Trip <i
                                                    class="fa-solid fa-plane"></i> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- <div class="item">
                                <div class="tour-box package-box destination-card">
                                    <a href="#">
                                        <img src="images/Tour-Package.webp" alt="tour">
                                    </a>
                                    <div class="tour-plans-content package-content">
                                        ...
                                        <div class="tour-bottom-content">
                                            ...
                                            <a href="#" class="comman-btn-hover" data-bs-toggle="modal"
                                                data-bs-target="#enquiry-form" class="">Book A Trip <i
                                                    class="fa-solid fa-plane"></i> </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="view-btn">
                        <a href="#" class="comman-btn-hover">View All Package</a>
                    </div>
                </div>
            </div>
        </div>
